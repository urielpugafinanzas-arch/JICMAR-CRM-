...
const Pedidos = {
  ...
  // Bug 3 fix: crea el documento si no existe, lo actualiza si ya está.
  // Usado por importarJSON para restaurar respaldos en cuentas nuevas.
...
export { db, auth, Auth, Config, Pedidos, Clientes, Storage, COLLECTIONS, serverTimestamp, Timestamp, collection, addDoc, getDocs, query, orderBy };
