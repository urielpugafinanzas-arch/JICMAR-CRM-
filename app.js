  ...
  container.innerHTML = lista.map(c => `
    <div class="cliente-card" style="cursor:pointer;" onclick="editarCliente('${c.id}')">
      ...
      <div class="cliente-info">
        ...
        ${c.ubicacion ? `<div class="cliente-detalle" style="display:flex;align-items:center;gap:0.5rem;"><span style="color:var(--accent2);">📍 Ubicación guardada</span></div>` : ''} ? `<div class="cliente-detalle" style="display:flex;align-items:center;gap:0.5rem;"><span style="color:var(--accent2);">📍 Ubicación guardada</span><button onclick="compartirUbicacionCliente('${(c.nombre||c.escuela||'').replace(/'/g,&quot;\\'&quot;)}',${c.ubicacion.lat},${c.ubicacion.lng},event)" style="padding:2px 10px;border-radius:20px;border:1px solid var(--accent2);background:transparent;color:var(--accent2);font-size:0.7rem;cursor:pointer;font-weight:600;">Compartir</button></div>` : ''}
      </div>
  ...
  sheet.innerHTML = `
    ...
    <div style="display:flex;flex-direction:column;gap:0.6rem;">
      <button onclick="
        ...
        document.getElementById('sheet-ubicacion').remove();
        document.querySelectorAll('[style*=z-index\\:9998]').forEach(e=>e.remove());
