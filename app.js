...
// Mostrar campo fecha caducidad si hay Charola jícama
...
window.confirmarCobro = async function () {
  ...
  // Solo bloquear monto 0 si NO hay devolución total y NO es modo edición
...
function renderSeguimiento(pedidos) {
  ...
  // Alertas de caducidad (2 días o menos)
