...
function renderPedidos() {
  ...
  container.innerHTML = lista.map(p => {
    ...
    const productosStr = Array.isArray(p.productos)
      ? p.productos.map(pr => 
          `<div style="display:flex;align-items:center;padding:2px 0;border-bottom:1px solid rgba(255,255,255,0.05);">
            <span style="font-weight:700;color:#f5a623;white-space:nowrap;margin-right:8px;">×${pr.cantidad}</span>
